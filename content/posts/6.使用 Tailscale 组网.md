...
- [~~HCC 指定 IDC 提供商~~ ⑤ 导](https://ecwu.cloud/) 的鼎立推荐
...
- 良好的网络环境
  - 拥有公网 IP 自然是最好的
  - 如果没有公网 IP，则需要良好的 NAT / 防火墙环境，这会影响 Tailscale 能否打洞成功
  >  Tailscale 官方关于 NAT 穿透的文章：[# How NAT traversal works](https://tailscale.com/blog/how-nat-traversal-works)（TL; DR 在两台需要连接的设备之间至少需要有一台是拥有良好的网络环境，设备之间才能打洞成功并直连）
